...
<body>
	<form class="sign-up" action="nuevoalumno.php" method="POST">
		...
		<input type="text" class="sign-up-input" name="nom_alum" placeholder="NOM. ALUMNO">

		<input type="text" class="sign-up-input" name="ape_alum" placeholder="APE. ALUMNO">
		...
		<select name="grupo_alum"> SELECCIONA 
		 ...
		 <a href="#popup"> <input type="submit" class="sign-up-input" class="sign-up-button" value="REGISTRAR"  required> </a>
	</form>
