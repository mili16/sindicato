...
$consulta="SELECT * FROM afiliado WHERE area_trabajo='extraccion'";
...
while ($row = $resultado->fetch_assoc()) {
	...
	$pdf->Cell(16, 8, utf8_decode( $row['area_trabajo']), 1, 0, 'C', 0);
